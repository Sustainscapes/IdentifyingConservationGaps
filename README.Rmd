...
We have a layer (subclasses) that has among its categories fields in rotation (INT_AGG), grasslands not covered by Article 3 protection ("PGR_out_of_P3") and production forest (Drevet Skov), we fuse this classes into one layer
