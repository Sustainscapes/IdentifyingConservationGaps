...
```{r RIA_privateUntouched, eval = FALSE}
...
5. **Other** (remaining terrestrial areas not covered by the above categories)
...
* `Subclasses` – land-cover subclasses used to identify remaining terrestrial areas
