...
These areas compromising biodiversity are identified for each protection
scheme. These areas are combined into a resulting raster that is then
used to derive the orange category in fig. 1.
...
2000 site that is also an Section 3 area). To produce the final map in
